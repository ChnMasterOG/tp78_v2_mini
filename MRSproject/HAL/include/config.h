...
#define HAL_MPR121_TOUCHBAR         FALSE            // MPR121触摸条 - 注意：修改此处还需同步库文件修改
#endif
#ifndef HAL_TPM
#define HAL_TPM                     FALSE            // 扩展模块
#endif
#ifndef TEM_SAMPLE
