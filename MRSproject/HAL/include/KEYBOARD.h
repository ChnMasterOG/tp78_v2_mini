 ...
 *******************************************************************************/
    ...
    #define LAYER_SIZE      4    // 除去当前布局，支持额外的层数
    #define ROW_SIZE        5    // 键盘行数 - 其它键盘布局需修改此处
    #define COL_SIZE        4    // 键盘列数 - 其它键盘布局需修改此处
    ...
    #define KEYPAD_Div      0x54
    #define KEYPAD_Mul      0x55
    #define KEYPAD_Sub      0x56
    ...
    #define KEYPAD_NonUS_WS 0x64
    #define KEYPAD_App      0x65
    #define KEYPAD_Power    0x66
    ...
    #define Fn_Mode_ChangeLayer0          0x20
    #define Fn_Mode_ChangeLayer1          0x21
    #define Fn_Mode_ChangeLayer2          0x22
    #define Fn_Mode_ChangeLayer3          0x23
    #define Fn_Mode_ChangeLayer4          0x24
    ...
    #define Fn_Mode_SelectNextDevice      0xE1
    #define Fn_Mode_BLE_ClearSNV          0xEF
    #define Fn_Mode_LED_NextStyle         0xF0
    ...
    extern uint8_t Extra_CustomKey[LAYER_SIZE][ROW_SIZE][COL_SIZE];
